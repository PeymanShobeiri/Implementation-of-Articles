...
public class ListPolicy3 extends WorkflowPolicy {

    public ListPolicy3(WorkflowGraph g, ResourceSet rs, long bw) {
        super(g, rs, bw);
    ...
    private result checkInstance(WorkflowNode curNode, Instance curInst) {
        ...
        if ((finishTime != 0 && curStart > curIntervalFinish) || curFinish > (curNode.getEFT() + (curNode.getLFT() - curNode.getEFT()) / 2)) //difference with PCPD2
